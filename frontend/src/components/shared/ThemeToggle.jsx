...
export default function ThemeToggle() {
  ...
  return (
    <div onClick={toggleTheme} className="flex cursor-pointer">
      ...
      <div
        className={`w-12 h-6 flex items-center rounded-full p-1 duration-300 ${darkMode ? "bg-blue-600" : "bg-gray-300"}`}
      >
        <div
          className={`bg-white w-4 h-4 rounded-full shadow-md transform duration-300 ${darkMode ? "translate-x-6" : "translate-x-0"}`}
        ></div>
      </div>
